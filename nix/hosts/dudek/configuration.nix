...
let
  host = baseNameOf ./.;
  hostAddress = flake.lib._metadata.hosts.${host}.primaryIPv4;
  inherit (flake.lib._metadata.hosts.${host}) hostId;
in
{
  ...
  headscale = {
    ...
    inherit (flake.lib._metadata) domain internalDomain;
    inherit hostAddress;
  };
  ...
  #   clientSecretsFile = "${flake}/secrets.yaml";
